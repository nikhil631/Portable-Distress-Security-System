...
def api_add_data(request,coor_x,coor_y,emerg,datetime=datetime.datetime.now()):
    ...
    # object_creator(factor={"roll_id":request.user.id,"coordinate_x":coor_x,"coordinate_y":coor_y,"emergency":emerg,"date_time":datetime},model="incoming_info")
