...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(7,'security','contact_info'),(8,'security','incoming_info'),(9,'security','relation_users'),(6,'sessions','session');
...
-- Dump completed on 2023-03-08 17:41:53
